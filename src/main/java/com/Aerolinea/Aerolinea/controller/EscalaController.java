...
public class EscalaController {
    ...
    @Operation(summary = "Este Endpoint, permite a los usuarios crear una nueva escala.En este endpoint los usuarios deben diligenciar los siguientes datos:" +
            " paisOrigen, paisDestino, ciudadOrigen, ciudadDestino, aeropuertoOrigen, aeropuertoDestino, fechaOrigen, fechaDestino. Los demas datos se agregan " +
            "automaticamente al hacer las respectivas asociaciones.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Este Endpoint, permite a los usuarios buscar una escala con base en su id unico. El usuario debe de suministrar el id " +
            "de la escala que desea buscar. En caso de no encontrar la escala se lanza una excepcion.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "OK: La solicitud se completo con exito y se devuelve la información solicitada, " +
    ...
    @Operation(summary = "Este Endpoint, le permite a los usuarios eliminar una escala de la base de datos. El usuario debe suministrar el id " +
            "de la escala que desea eliminar de la base de datos.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Este Endpoint, le permite a los usuarios editar un vuelo especifico de la base de datos. El usuario debe de suministrar el id " +
            "del vuelo que desea editar y en el JSON debe de suministrar los siguientes datos: paisOrigen, paisDestino, ciudadOrigen, ciudadDestino, aeropuertoOrigen, " +
            "aeropuertoDestino, fechaOrigen, fechaDestino. Los demas datos se deben mantener igual.")
    @ApiResponses(value = {
